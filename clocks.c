...
// -----------------------------------------------------------------------------
  ...
  /*
timersb0.r43 uses CCR0 to create the TimeSequence variable I've been using since
the start of the semester
*/

  // note: eventually need to make these files and get rid of switches.c
  // also need to look at how debouncing works with interrupts
  // interrupt_timers.c
  // interrupt_ports.c
  // interrupt_adc.c

  //timers.c / replaces old timersB0.r43
